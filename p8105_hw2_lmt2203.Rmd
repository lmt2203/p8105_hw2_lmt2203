...
This dataset contains `r names(nyc_transit_df)` variables. Dimensions of the dataset is `r dim(nyc_transit_df)`.

This code chunk is to reformat data so that route number and route names are distinct variables.
