...
entrance\_type, ada variables. The dataset has dimensions of 1868 rows
and 19 columns. I imported the dataset, changed the variable names to
snake cases, select the variables of interest and converted the entry
